...
const AdminApp = () => {
  ...
  const renderContent = () => {
    switch (activeMenu) {
      ...
      case "lawyers":
        return <AdminLawyerApprovePage />;
      case "community":
        return <AdminCommunityPage />; // cases 렌더링을 community로 교체
      case "payments":
      ...
      <main className="admin-main">
        <header className="admin-header">
          <div className="admin-breadcrumb">
            LawMate Admin <ChevronRight size={13} />{" "}
