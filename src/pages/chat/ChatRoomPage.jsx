...
const ChatRoomPage = () => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', maxWidth: '1100px', margin: '0 auto',
      background: '#fff', border: '1px solid #E8ECF0' }}>

      {/* ── 왼쪽 채팅목록 사이드바 ── */}
      <div style={{ width: '300px', borderRight: '1px solid #E8ECF0',
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          {rooms.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '40px 16px', color: '#aaa', fontSize: '13px' }}>
              대화가 없습니다
            </div>
          ) : (
            rooms.map((room) => (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '3px' }}>
                    <span style={{ fontWeight: '700', fontSize: '14px', color: '#1A1A2E' }}>
                      ...
                      {room.targetRole === 'LAWYER' && (
                        <span style={{ marginLeft: '5px', fontSize: '10px', background: '#E8F0FF',
                          color: '#1A6DFF', padding: '1px 5px', borderRadius: '4px' }}>변호사</span>
                      )}
                    </span>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: '700', fontSize: '16px', color: '#1A1A2E' }}>
              ...
              {currentRoom?.targetRole === 'LAWYER' && (
                <span style={{ marginLeft: '8px', fontSize: '12px', background: '#E8F0FF',
                  color: '#1A6DFF', padding: '2px 8px', borderRadius: '6px' }}>변호사</span>
              )}
            </div>
